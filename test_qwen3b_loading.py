#!/usr/bin/env python3
"""Test if Qwen2.5-3B loads properly on this machine."""
...
def test_qwen3b_loading():
    print("Testing Qwen2.5-3B model loading...")
...
if __name__ == "__main__":
    success = test_qwen3b_loading()
    if success:
        print("\n✓ Qwen2.5-3B loading test successful!")
    else:
        print("\n✗ Qwen2.5-3B loading test failed!")